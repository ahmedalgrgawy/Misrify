      ...
      <div className="p-6">
        ...
        <div className="flex flex-col justify-between gap-5 max-w-5xl mx-auto p-6">
          {messagesArray.length > 0 ? (
            messagesArray.map(
              ({ _id, firstName, lastName, email, message }) => {
                ...
                return (
                  <div
                    key={_id}
                    className="bg-white p-6 shadow-md border border-gray-200 rounded-lg transition ease-in hover:shadow-lg duarition-400"
                  >
                    ...
                    <p className="text-sm text-gray-600 mb-2 ml-9">{email}</p>
                    <p className="text-main-blue mt-3 font-semibold">
                      {message}
                    </p>
                  </div>
                );
