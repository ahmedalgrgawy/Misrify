...
router.put("/edit-user-role/:id", catchAsync(protectedRoute), catchAsync(adminRoute), catchAsync(editUser))

router.delete("/delete-user/:id", catchAsync(protectedRoute), catchAsync(adminRoute), catchAsync(deleteUser))
